...
- portfolio_rationalize: {} — monthly portfolio rationalization analysis: score all positions, rank by quality/growth/value/sentiment, recommend which 15 to keep (FAST if recent file ≤30 days; otherwise dispatches Windmill job ~10 min)
