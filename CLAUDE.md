...
**Summary:** Agent fully live — FastAPI service, Telegram webhook, 15 commands (alphabetical), W2/W3/W4 tools + candidate_evaluation, /macro→macro_brief (24 indicators, 6 groups), /candidate fast-path, push notifications from 5 Windmill scripts, macro_daily_push at 7:30 AM SGT, 403 tests passing. Pending: Agent Drafts Telegram group (manual owner task).
